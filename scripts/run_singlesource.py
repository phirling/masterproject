...
final_time = swift_time_unit_s * 1.8e-4 #0.1 # Final time of the simulation
...
output_times = swift_time_unit_s * np.array([1e-5,2e-5,4e-5,6e-5,8e-5,1e-4,1.2e-4,1.6e-4,1.8e-4]) #np.loadtxt("output_times.txt")
